...
#
# Emcraft SoM Kit for Microsemi M2S010-FGG484 (2014)
...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p7/g4craft1s_lnk
set PATH_IMPORTED  ../../11p7/g4craft1s_src
...
save_project_as -location $PATH_IMPORTED -name {g4craft1s_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g4craft1s_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
