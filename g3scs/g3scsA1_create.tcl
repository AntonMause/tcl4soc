...
#
# SCS Kit for Microsemi M1A3P1000-FGG484
#
# untested
#
...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p9/g3scsA1_lnk
set PATH_IMPORTED  ../../11p9/g3scsA1_src
...
# create new project
new_project -location $PATH_LINKED -name {g3scsA1_lnk} -project_description {G3 M1A3P DEV SCS SA} \
	-block_mode 0 -standalone_peripheral_initialization 0 -use_enhanced_constraint_flow 1 -hdl {VHDL} \
	-family {ProASIC3} -die {M1A3P1000} -package {484 FBGA} -speed {STD} -die_voltage {1.5} \
...
save_project_as -location $PATH_IMPORTED -name {g3scsA1_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g3scsA1_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
