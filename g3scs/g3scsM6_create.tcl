...
#
# SCS Kit for Microsemi M1AGL600V2-FGG256
#
# untested
#
...
# create new project
new_project -location $PATH_LINKED -name {g3scsM6_lnk} -project_description {G3 M1AGL600V2 DEV SCS SA} \
	-block_mode 0 -standalone_peripheral_initialization 0 -use_enhanced_constraint_flow 1 -hdl {VHDL} \
	-family {IGLOO} -die {M1AGL600V2} -package {256 FBGA} -speed {STD} -die_voltage {1.2} \
...
save_project_as -location $PATH_IMPORTED -name {g3scsM6_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g3scsM6_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
