...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p7/g3icicle_lnk
set PATH_IMPORTED  ../../11p7/g3icicle_src
...
# create new project
new_project -location $PATH_LINKED -name g3icicle_lnk -project_description {G3 Icicle Kit} \
	-block_mode 0 -standalone_peripheral_initialization 0 -use_enhanced_constraint_flow 1 -hdl {VHDL} \
	-family {IGLOO} -die {AGL125V2} -package {132 QFN} -speed {STD} -die_voltage {1.2~1.5} \
