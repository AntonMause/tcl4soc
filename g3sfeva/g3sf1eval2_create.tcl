...
#
# SmartFusion(1) Evaluation Kit for Microsemi A2F200
#
# untested
#
...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p9/g3sf1eval2_lnk
set PATH_IMPORTED  ../../11p9/g3sf1eval2_src
...
# create new project
new_project -location $PATH_LINKED -name g3sf1eval2_lnk -project_description {G3 AF200 EvalKit} \
	-block_mode 0 -standalone_peripheral_initialization 0 -use_enhanced_constraint_flow 1 -hdl {VHDL} \
	-family {SmartFusion} -die {A2F200M3F} -package {484 FBGA} -speed {STD} -die_voltage {1.5} \
	-part_range {COM} -adv_options {IO_DEFT_STD:LVCMOS 3.3V} \
	-adv_options {RESTRICTPROBEPINS:1} -adv_options {RESTRICTSPIPINS:0} -adv_options {TEMPR:COM} \
