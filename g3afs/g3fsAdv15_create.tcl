...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p9/g3fsAdv15_lnk
set PATH_IMPORTED  ../../11p9/g3fsAdv15_src
...
# create new project
new_project -location $PATH_LINKED -name {g3fsAdv15_lnk} -project_description {G3 Fusion Advanced Dev Kit} \
...
create_links \
         ...
         -hdl_source {./brdLexSwxAdv.vhd} \
         -hdl_source {./brdRstClk.vhd} \
         -hdl_source {./brdConstAdv_pkg.vhd} \
...
save_project_as -location $PATH_IMPORTED -name {g3fsAdv15_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g3fsAdv15_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
