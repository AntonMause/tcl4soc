...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p9/g4maker1s_lnk
set PATH_IMPORTED  ../../11p9/g4maker1s_src
...
# create new project
new_project -location $PATH_LINKED -name {g4maker1s_lnk} -project_description {G4 M2GL010 DigiKey Maker Board} \
...
save_project_as -location $PATH_IMPORTED -name {g4kick1s_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g4kick1s_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
