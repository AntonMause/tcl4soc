...
#
# DigiKey Maker Board for Microsemi M2S010-TQG144
...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p9/g4maker1g_lnk
set PATH_IMPORTED  ../../11p9/g4maker1g_src
...
# create new project
new_project -location $PATH_LINKED -name {g4maker1g_lnk} -project_description {G4 M2GL010 DigiKey Maker Board} \
	-block_mode 0 -standalone_peripheral_initialization 0 -use_enhanced_constraint_flow 1 -hdl {VHDL} \
	-family {IGLOO2} -die {M2GL010} -package {144 TQ} -speed {STD} -die_voltage {1.2} \
...
save_project_as -location $PATH_IMPORTED -name {g4kick1g_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g4kick1g_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
