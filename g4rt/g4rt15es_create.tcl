...
#
# Microsemi RTG4 ES Kit for (2014)
# Board populated with engineering sample silicon
#
# untested
#
...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p7/g4rt15es_lnk
set PATH_IMPORTED  ../../11p7/g4rt15es_src
...
# create new project
new_project -location $PATH_LINKED -name {g4rt15es_lnk} -project_description {RTG4 150 ES DevKit} \
	-block_mode 0 -standalone_peripheral_initialization 0 -use_enhanced_constraint_flow 1 -hdl {VHDL} \
	-family {RTG4} -die {RT4G150_ES} -package {1657 CG} -speed {STD} -die_voltage {1.2} \
...
create_links \
         ...
         -hdl_source {./brdRstClkEs.vhd} \
         -hdl_source {./brdConst_pkg.vhd} \
         -hdl_source {./IniSftDivEs.vhd} \
...
save_project_as -location $PATH_IMPORTED -name {g4rt15es_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g4rt15es_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
