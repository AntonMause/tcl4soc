...
# 
set PATH_SOURCES   .
set PATH_LINKED    ../../11p7/g4img2g_lnk
set PATH_IMPORTED  ../../11p7/g4img2g_src
...
# create new project
new_project -location $PATH_LINKED -name {g4img2g_lnk} -project_description {G4 M2GL025 IMG DevKit} \
...
save_project_as -location $PATH_IMPORTED -name {g4img2g_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 

# copy project to ZIP archive
project_archive -location $PATH_LINKED -name {g4img2g_src} -replace_links 1 -files {all} -designer_views {all} 
save_project 
